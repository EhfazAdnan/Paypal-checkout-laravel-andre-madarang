...
Route::post('create-payment', function () {
    $apiContext = new \PayPal\Rest\ApiContext(
        new \PayPal\Auth\OAuthTokenCredential(
            'AUl4TdKSUb5ZuTwizqZb1nxmpHE2h1FtgwJo24nOYg_qOIQkQtyS-5o6JGpfsPiNloIYnXrHrNbhaXXB',     // ClientID
            'EN5uGvuS7XFkoLHpK7V5ZTmhCfRfGL5NKVehUpJlHGiEGvACKjsA_zmah7uOfL-nF28bJMCMdZFGpXrb'      // ClientSecret
        )
    );
